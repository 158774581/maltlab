% This file is the slblocks file for the twolink Simulink library.
...
Browser.Library = 'twolinkslib';
Browser.Name = 'twolink';
Browser.IsFlat = 1;
 
blkStruct.Name = ['twolink', sprintf('\n'), 'Library'];
blkStruct.OpenFcn= 'twolinkslib';
