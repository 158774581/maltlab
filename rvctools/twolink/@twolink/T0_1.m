...
%% T0_1 - Forward kinematics for the two link copy arm up to frame 1 of 2. 
% ========================================================================= 
%    
%    T = T0_1(rob,q) 
%    T = rob.T0_1(q) 
...
%    
%  Output:: 
%    T:  [4x4] Homogenous transformation matrix relating the pose of joint 1 of 2 
...
T0_1 = reshape([t2,t4,t3,0.0,-t3,t2.*6.123233995736766e-17,t2,0.0,0.0,-1.0,6.123233995736766e-17,0.0,t2,t4,t3,1.0],[4,4]);
