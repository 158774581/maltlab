...
%% FKINE - Forward kinematics solution including tool transformation for the two link copy arm. 
% ========================================================================= 
%    
%    T = fkine(rob,q) 
%    T = rob.fkine(q) 
...
%    
%  Input:: 
%    rob: robot object of two link copy specific class 
...
t3 = cos(t2);
t4 = sin(t2);
t5 = t4.*6.123233995736766e-17;
t6 = sin(q1);
fkine = reshape([t3,t5,t4,0.0,-t4,t3.*6.123233995736766e-17,t3,0.0,0.0,-1.0,6.123233995736766e-17,0.0,t3+cos(q1),t5+t6.*6.123233995736766e-17,t4+t6,1.0],[4,4]);
