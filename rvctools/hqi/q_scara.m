...
L(1) = Link('d', 0, 'a', 0.25, 'alpha', 0, ...
    ...
    'r', [0.11652-0.25,  0,  -0.02891], ...  % r is on the forward of joint in standart D-H
    'm', 2.247, ...
    'Jm', 117.494618e-6, ...
    'G', 80, ...
    'B', 1.48e-3, ...
...
% scara.fast=0;
%  T=scara.fkine(q(18,:))
%  Q=scara.ikine(T,[0 1 1 0],[1 1 1 0 0 1])
%scara.plot(q)
...
% qd(18,:);
% qdd(18,:);
% tau=rne_dh(scara,q(18,:), qd(18,:), qdd(18,:));

J=scara.jacob0([0 pi/6 0.3 pi/6])